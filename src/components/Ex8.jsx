...
export default function Ex8() {
  ...
  return (
    ...
    <section className="flex justify-center items-center mb-12 hover:scale-105 ">
      <div className="bg-white p-6 rounded-lg shadow-md hover:shadow-[5px_5px_5px] w-64 text-center">
